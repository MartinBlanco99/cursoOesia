...
public class Principal3 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		imprimirFiltradaNombreGenerico2(lista, (p) -> p.getNombre().equals("patricio"));
	...
	public static void imprimirFiltradaNombreGenerico2(List<Persona> lista, Predicate<Persona> filtro) {
		for (Persona p : lista) {
			if (filtro.test(p)) {
				System.out.println(p.getNombre() + " " + p.getApellidos() + " " + p.getEdad());
			}
